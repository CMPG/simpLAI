The folders in this directory contain the simulated data used in Oliveira et al., 2024 (Assessing the limits of local ancestry inference from small reference panels).

The simulated data can be generated with fastsimcoal v2.8 using the definition file (e.g., SimAdm.def) and the template file (e.g., SimAdm.tpl).
...
The files created are numbered from 1 to the number of parameter combinations (lines).
